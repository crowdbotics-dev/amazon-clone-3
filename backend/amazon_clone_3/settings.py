"""
Django settings for amazon_clone_3 project.
...
ROOT_URLCONF = 'amazon_clone_3.urls'
...
WSGI_APPLICATION = 'amazon_clone_3.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Amazon Clone Support <support@amazon-clone-3.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "amazon_clone_3 API",
    "DESCRIPTION": "API documentation for amazon_clone_3 App",
    "VERSION": "v1",
}
